...
#ifndef RESTAURANT_FINDER_SWIFT_H
#define RESTAURANT_FINDER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="restaurant_finder",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC17restaurant_finder11AppDelegate")
...
SWIFT_CLASS("_TtC17restaurant_finder17MainFlutterWindow")
